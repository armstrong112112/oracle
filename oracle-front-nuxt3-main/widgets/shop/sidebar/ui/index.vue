  ...
  <div class="shop-sidebar">
    ...
    <div class="navigation">
      <div v-for="nav in navigation" :key="nav.id" class="navigation-block">
        <div class="navigation-link" :class="{ active: isActiveLink(nav) }" @click="handleClick(nav)">
          ...
          <div class="navigation-name-container">
            ...
            <div v-if="nav.dropdown">
              <img :src="'/svg/shop/icons/arrow-down.svg'" alt="arrow" :class="{ open: openDropdownId === nav.id }" />
            </div>
          </div>
        </div>

        <transition name="accordion">
          <div v-if="nav.dropdown && openDropdownId === nav.id" class="navigation-dropdown">
            <nuxt-link v-for="child in nav.children" :key="child.id" :to="child.link" class="navigation-dropdown-item">
              {{ child.name }}
            </nuxt-link>
          </div>
        </transition>
...
import { NavigationDto, type NavigationType } from "../dto/data.dto";
...
const handleClick = (nav: NavigationType) => {
  if (nav.dropdown) {
...
const isActiveLink = (nav: NavigationType) => {
