<template>
  <div class="telegram-auth-update-content">
    <div class="telegram-auth-update-content__content">
      <div class="telegram-auth-update-content__header">
        <TelegramIcon class="telegram-icon" />
        <Logo />
      </div>
      <h1 class="telegram-auth-update-content__title">
        {{ $t("moreSettings.logInToUseTelegram") }}<br />
        {{ $t("moreSettings.accountWithExampleAndBot") }}
      </h1>
      <p class="telegram-auth-update-content__description">
    ...
    <div class="telegram-auth-update-content__button">
      <new-oracle-button
...
const handleNext = () => {
  if (
    props.isModal &&
    phoneInputMaxLength.value === phoneNumberRaw.value.length
  ) {
