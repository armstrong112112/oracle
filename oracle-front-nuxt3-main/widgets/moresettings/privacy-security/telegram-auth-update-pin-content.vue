<template>
  <div class="telegram-auth-update-pin-content">
    <form class="telegram-auth-update-pin-content__form">
      <h2 class="telegram-auth-update-pin-content__title">
        {{ $t('moreSettings.verifyAccountViaTelegram') }}
      </h2>
      <p class="telegram-auth-update-pin-content__description">
      ...
      <div class="telegram-auth-update-pin-content__button">
        <new-oracle-button
...
.telegram-auth-update-pin-content {
  &__form {
    display: flex;
