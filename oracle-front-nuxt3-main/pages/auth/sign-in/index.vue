<template>
  <div class="auth">
    ...
    <div class="auth-content">
      <AuthHeader />
      <div class="sign_in">
        <div class="sign_in_title">{{ $t("auth.signIn") }}</div>
        ...
        <div class="flex items-center justify-center">
          <nuxt-link
            :to="localePath('/auth/sign-in-with-telegram')"
            class="tg-btn">
      ...
      <div class="auth_footer">
        ...
        <div class="auth_text">
          ...
          <nuxt-link :to="localePath('/auth/sign-up')" class="primary-color">{{
...
const openOtp = async () => {
  ...
  try {
    ...
    router.push(localePath("/auth/sign-in/otp"));
  } catch (error) {
