<template>
  <history-layout
    ...
    :deposit-title="$t('history.fees.title')"
    :expenses-title="$t('history.fees.title')"
    :deposit-tab-title="$t('history.fees.networkFees')"
    :expenses-tab-title="$t('history.fees.compensationsBonuses')"
