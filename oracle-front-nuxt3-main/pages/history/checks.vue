<template>
  <history-layout
    ...
    :deposit-title="$t('history.checks.title')"
    :expenses-title="$t('history.checks.title')"
    :deposit-tab-title="$t('history.checks.issuedChecks')"
    :expenses-tab-title="$t('history.checks.cashedChecks')"
...
const openModal = () => {
  // type, item: any
  currentModalData.value = { ...escrowDataRef } // Использованы данные другой страницы
