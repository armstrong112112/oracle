      ...
      <template v-for="(group, date) in groupedNotifications" :key="date">
        ...
        <div
          ...
          <div class="notification-content">
            ...
            <div v-if="notification.status" class="notification-subtitle">
...
import {
  p2pData,
  type P2PNotificationItem,
} from "~/entities/notification/data/p2pData";
...
const notificationData: P2PNotificationItem[] = p2pData;

const filteredNotifications = computed((): P2PNotificationItem[] => {
...
const groupedNotifications = computed(
  (): {
    [key: string]: P2PNotificationItem[];
  } => {
    const grouped: { [key: string]: P2PNotificationItem[] } = {};
