      ...
      <template v-for="(group, date) in groupedNotifications" :key="date">
        ...
        <div
          ...
          <div class="notification-content">
            <div v-if="notification.type" class="notification-main-row">
            ...
            <div v-if="notification.fee" class="notification-subtitle">
              {{ $t("notifications." + notification.fee) }}
            </div>

            <div v-if="notification.user" class="user-info">
...
import {
  escrowData,
  type EscrowNotificationItem,
} from "~/entities/notification/data/escrowData";
...
const notificationData: EscrowNotificationItem[] = escrowData;

const filteredNotifications = computed((): EscrowNotificationItem[] => {
...
const groupedNotifications = computed(
  (): {
    [key: string]: EscrowNotificationItem[];
  } => {
    const grouped: { [key: string]: EscrowNotificationItem[] } = {};
