      ...
      <template v-for="(group, date) in groupedNotifications" :key="date">
        ...
        <div
          ...
          <div class="notification-content">
            ...
            <div v-if="notification.for" class="user-info">
              <div class="for-label">For</div>
              <div class="user-avatar">
                <img
                  :src="notification.for.avatar"
                  :alt="notification.for.name" />
              </div>
              <div class="user-name">{{ notification.for.name }}</div>
            </div>
            <div v-else-if="notification.user" class="user-info">
              <div class="user-avatar">
                <img
...
} from "~/entities/notification/data/marketData";
...
const notificationData: MarketNotificationItem[] = marketData;

const filteredNotifications = computed((): MarketNotificationItem[] => {
...
const groupedNotifications = computed(
  (): {
    [key: string]: MarketNotificationItem[];
  } => {
    const grouped: { [key: string]: MarketNotificationItem[] } = {};
