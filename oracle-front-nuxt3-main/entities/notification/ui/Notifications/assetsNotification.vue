          ...
          <div class="notification-content">
            <div class="notification-main-row">
              <div class="notification-chips">
                {{ $t("notifications." + notification.network) }}
              </div>
            </div>
            <div class="notification-main-row">
...
import {
  assetsData,
  type AssetsNotificationItem,
} from "~/entities/notification/data/assetsData";
...
const notificationData: AssetsNotificationItem[] = assetsData;

const filteredNotifications = computed((): AssetsNotificationItem[] => {
...
const groupedNotifications = computed(
  (): {
    [key: string]: AssetsNotificationItem[];
  } => {
    const grouped: { [key: string]: AssetsNotificationItem[] } = {};
