...
import {
  shopData,
  type ShopNotificationItem,
} from "~/entities/notification/data/shopData";
...
const notificationData: ShopNotificationItem[] = shopData;

const filteredNotifications = computed((): ShopNotificationItem[] => {
...
const groupedNotifications = computed(
  (): {
    [key: string]: ShopNotificationItem[];
  } => {
    const grouped: { [key: string]: ShopNotificationItem[] } = {};
