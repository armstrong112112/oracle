...
| `useCartStore` | товар из API, не из ProductsData | ✅ | `ADD_TO_CART` запрашивает `/shop/products/:id`, проверяет наличие |
...
15. [ ] Ручная проверка DoD #9 (один запрос в Network, без hydration mismatch) после выполнения P0–P1.
