    ...
    <div class="orders-product-page__container">
      ...
      <div class="order-completed">
        ...
        <div class="order-status">
          <img src="/svg/shop/icons/tick.svg" alt="tick" />
          <h4>Completed</h4>
        </div>
      </div>
      ...
      <div class="container__actions">
        <button @click="OpenFeedBack">Leave a Feedback</button>
        <button @click="OpenSuccess">Order again</button>
      </div>
    </div>
    <FeedbackModal v-if="feedback" @close="CloseFeedBack" />
    <SuccessModal v-if="success" @close="CloseSuccess" />
  </div>
</template>
...
import SuccessModal from "~/features/shop/order/modal/success-modal.vue";
