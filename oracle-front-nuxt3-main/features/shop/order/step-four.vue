<template>
  <div class="orders-product-page">
    <div class="orders-product-page__container">
      ...
      <div v-if="profile?.role !== 'seller'" class="orders-overdue">
        <h2>Action Needed on Delivery</h2>
        <h5>
          Approve the work or request revisions or open dispute. If you take no
          action, payment will be released automatically.
        </h5>
        <h3>23:32:38 min</h3>
      </div>
...
const approve_delivery_btn: WarnButton[] = [
  {
    text: "Cancel",
