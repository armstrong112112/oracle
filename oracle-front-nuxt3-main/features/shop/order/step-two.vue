  ...
  <div class="orders-product-page">
    <div class="orders-product-page__container">
      ...
      <div class="container__actions">
        <button @click="OpenWarn" v-if="profile?.role !== 'seller'">
          Request Update
        </button>
        <button @click="deliver_work_modal" v-if="profile?.role === 'seller'">
          Send Update
        </button>
        <button @click="SellerWarn" v-if="profile?.role === 'seller'">
          Complete Order
        </button>
      </div>
    </div>
...
const warn_modal = ref(false);
const seller_warn_modal = ref(false);
const deliver_work = ref(false);
...
const SellerWarnClose = () => {
  seller_warn_modal.value = false;
};

const warn_button = ref<WarnButton[]>([
  {
    text: "Cancel",
    onClick: () => CloseWarn(),
  },
...
const seller_warn_button = ref<WarnButton[]>([
  {
    text: "Cancel",
  ...
  },
  {
    ...
    onClick: () => router.push("/shops/order?order=complete"),
  },
]);
...
const deliver_work_modal = () => {
  deliver_work.value = true;
};

const close_deliver_work_modal = () => {
