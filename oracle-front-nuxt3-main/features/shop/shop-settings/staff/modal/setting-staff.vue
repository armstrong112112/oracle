          ...
          <div
            ...
            <div class="input-toggle__toggle">
              <div
                ...
                @click="action_value_function(item.id)">
                <div
                  :class="{
...
const emit = defineEmits<{
  close: []
  'delete-staff': [value: boolean]
}>()

const permission_list = ref<ActionsType[]>([
  { id: 1, title: "Change Shop's Name", permission: props.profile?.permission?.shopName || false },
  { id: 2, title: "Change Shop's Bio", permission: props.profile?.permission?.shopBio || false },
  { id: 3, title: "Change Shop's Avatar", permission: props.profile?.permission?.shopAvatar || false },
  { id: 4, title: "Change Staff Settings", permission: props.profile?.permission?.staffSetting || false },
  { id: 5, title: "Add New Employees", permission: props.profile?.permission?.addNewEmployee || false },
  { id: 6, title: "Send Messages", permission: props.profile?.permission?.sendMessage || false },
  { id: 7, title: "Delete Employees", permission: props.profile?.permission?.deleteEmployee || false }
])

const action_value_function = (id: number): void => {
  const item = permission_list.value.find(item => item.id === id)
  if (item) {
