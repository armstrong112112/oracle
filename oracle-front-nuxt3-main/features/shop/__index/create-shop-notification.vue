<template>
  <div>
    <div class="create-shop__container blur">
      <div class="create-shop-blur">
        ...
        <div class="create-shop__buttons">
          <nuxt-link to="/shops" class="btn cancel">Cancel</nuxt-link>
          <nuxt-link to="/shops" class="btn back">Go Back</nuxt-link>
          <nuxt-link to="/shops?store=form" class="btn create"
            >Create Store</nuxt-link
          >
        </div>
      </div>
    </div>
